...
let Bullet = (() => {
    ...
    var Bullet = _classThis = class extends _classSuper {
        constructor() {
            super(...arguments);
            this.Speed = __runInitializers(this, _Speed_initializers, 800);
            this.bulletPool = (__runInitializers(this, _Speed_extraInitializers), null);
        }
        start() {
            // 檢查 bulletPool 是否已經被初始化
            if (!this.bulletPool) {
                // 從父節點或場景中獲取 BulletPool 組件
                this.bulletPool = this.node.parent.getComponent(BulletPool_1.default);
            }
    ...
    __setFunctionName(_classThis, "Bullet");
    (() => {
        var _a;
        ...
        Bullet = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Bullet = _classThis;
})();
